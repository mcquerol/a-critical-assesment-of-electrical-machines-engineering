...
MODEL               = machinelab
MODULES             = rt_matrx.c rt_printf.c rt_logging.c machinelab.c machinelab_capi.c machinelab_data.c machinelab_tgtconn.c rtGetInf.c rtGetNaN.c rt_nonfinite.c rt_logging_mmi.c rtw_modelmap_utils.c raccel_main_new.c raccel_sup.c raccel_mat.c simulink_solver_api.c raccel_utils.c common_utils.c ext_svr.c updown.c ext_work.c rtiostream_interface.c rtiostream_tcpip.c rtiostream_utils.c sfun_spid_contc.c
MAKEFILE            = machinelab.mk
...
MASTER_ANCHOR_DIR   = 
START_DIR           = H:/Electrical and Electronic Engineering/Year 2/Electrical Machines/Lab 4
...
MODELREF_LINK_LIBS        = 
MODELREF_LINK_RSPFILE     = machinelab_ref.rsp
...
ADD_INCLUDES = \
	-I$(START_DIR) \
	-I$(START_DIR)/slprj/raccel/machinelab \
...
rt_matrx.obj : C:\Program\ Files\MATLAB\R2019b\rtw\c\src/rt_matrx.c
	$(CC) -c -Fo$(@F) $(CFLAGS) C:\Program\ Files\MATLAB\R2019b\rtw\c\src/rt_matrx.c

rt_printf.obj : C:\Program\ Files\MATLAB\R2019b\rtw\c\src/rt_printf.c
	$(CC) -c -Fo$(@F) $(CFLAGS) C:\Program\ Files\MATLAB\R2019b\rtw\c\src/rt_printf.c
